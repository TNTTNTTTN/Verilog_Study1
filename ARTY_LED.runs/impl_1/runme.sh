...
HD_PWD='F:/Xilinx/ARTY_LED/ARTY_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binkled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binkled.tcl -notrace
