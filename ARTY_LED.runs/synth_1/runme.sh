...
HD_PWD='F:/Xilinx/ARTY_LED/ARTY_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binkled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binkled.tcl
